...
public class LanguagesTechnologyManager implements LanguagesTechnologyService{
	...
	public Optional<GetByIdLanguageTechnologyResponse> getById(int id) {
		LanguageTechnology languageTechnology=languagesTechnologyRepository.findById(id).get();
		GetByIdLanguageTechnologyResponse getByIdReponse=new GetByIdLanguageTechnologyResponse();
		getByIdReponse.setId(languageTechnology.getId());
		getByIdReponse.setLanguageId(languageTechnology.getLanguage().getId());
		getByIdReponse.setName(languageTechnology.getTechnologyName());
	
		return Optional.ofNullable(getByIdReponse);
	}
